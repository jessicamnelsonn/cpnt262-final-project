...
<body class="bg-cover bg-center p-8" style="background-image: url('images/view-image.jpg');">
  <div>
  ...
  <form action="/submit_reservation" method="post" class="max-w-md mx-auto mt-8 bg-gray-950 bg-opacity-75 p-8 rounded-md text-white">
    ...
    <select name="people" id="people-select" class="w-full p-2 mb-4 bg-zinc-500 text-white cursor-pointer hover:bg-gray-600">
